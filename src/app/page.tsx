          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
              <Card className="border-zinc-200 bg-transparent shadow-none h-full">
                <CardHeader>
                  <div className="mx-auto h-16 w-16 rounded-md bg-zinc-100 flex items-center justify-center">
                    <UserPlus className="h-8 w-8 text-orange-500" />
                  </div>
                </CardHeader>
                <CardContent className="space-y-2">
                  <h3 className="text-2xl font-bold">1. Create Account</h3>
                  <p className="text-zinc-500">Sign up as a client or freelancer to get started.</p>
                </CardContent>
              </Card>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.4 }}>
              <Card className="border-zinc-200 bg-transparent shadow-none h-full">
                ...
                <CardContent className="space-y-2">
                  ...
                  <p className="text-zinc-500">Browse available gigs or post a job for freelancers to apply to.</p>
                </CardContent>
              </Card>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.6 }}>
              <Card className="border-zinc-200 bg-transparent shadow-none h-full">
                ...
                <CardContent className="space-y-2">
                  ...
                  <p className="text-zinc-500">Collaborate, manage projects, and get paid securely.</p>
                </CardContent>
              </Card>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {[ 
              ...
              <motion.div key={category.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.1 }}>
                <Card className="p-6 text-center border-zinc-200 hover:border-orange-500 transition-colors cursor-pointer h-full">
                  {category.icon}
            ...
            <CarouselContent>
              {testimonials.map((testimonial, index) => (
                <CarouselItem key={index}>
                  <Card className="p-8 border-zinc-200 shadow-none">
                    <div className="relative">
                      <Quote className="absolute -top-4 -left-4 h-12 w-12 text-zinc-100" />
